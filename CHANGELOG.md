...
- add opt-out/override knob for statusline autoconfig (#936)

### Fix

- **hooks**: stop gh_footer_hook mutating agent body files; fix footer duplication, add opt-out (#937) (#938)

### Refactor

- unify statusLine ownership detection across removal paths (stacked on #936) (#940)

## v6.5.81 (2026-07-17)

### Fix

- stop routing MPM agents to global ~/.claude/agents/ (#924 Fix A) (#935)

## v6.5.80 (2026-07-17)

### Fix

- rename mcp-token skills to model-context to stop /mcp slash-command shadowing (#932)
- add WWL doc-comment to SessionPauseManager._terminate_one_mcp_process (#933)
...
- exclude nested worktrees from structure linter file-walk (#929)
- terminate stale MCP stdio servers on session pause (#928)

## v6.5.77 (2026-07-03)

### Feat

- filter agent capabilities by per-project manifest (#926)

## v6.5.76 (2026-07-03)

### Feat

- enforce agent deprecated: true at the tool-dispatch layer (#925)

### Fix

- **deployment**: distinguish skipped CORE agents from successful deploys (#921)

## v6.5.75 (2026-07-02)

### Fix

- **deployment**: stop re-creating project-level duplicates for USER_LEVEL_AGENTS (#918)

## v6.5.74 (2026-07-01)

### Fix

- **skill**: accuracy audit across skill documentation - closes #914

## v6.5.73 (2026-07-01)

### Fix

- implement WorktreeRemove cleanup in Python hook path (#912) (#913)
...
- gh_footer_hook advisory hardening follow-ups (#891) (#903)

## v6.5.69 (2026-06-24)

### Fix

- harden MPM against CC 2.1.166 SendMessage authority change (#901) (#902)
...
- **trusty-search**: auto-rebuild missing/empty/stale index with wait-or-background decision (#900)
...
- guard release-check against double version bumps (#896) (#897)
...
- **session-pause**: sweep orphaned dirs under .claude/worktrees/ (#894) (#895)
...
- **session-pause**: prune stale worktrees at pause time (#892) (#893)
...
- **skills**: deploy bundled skills at user level + remove project-level duplicates (#804) (#805)

### Fix

- **skills**: version-aware bundled-skills TTL so new skills deploy after upgrade (#802) (#803)
...
- cap PM_memories.md at 4KB in MemoryManager load path
- add memory.use_mcp_backend config key to MemoryConfig
- skip PM_memories.md injection when MCP memory backend detected
- lazy-load WORKFLOW.md from PM system prompt assembly

### Refactor

- compress MEMORY.md to reduce token footprint

### Perf

- strip example blocks from capability generator rendering
...
- add git branch and ahead/behind to MPM status line
...
- rename mcp-builder skill to avoid /mcp native command conflict
