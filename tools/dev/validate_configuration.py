...
class ConfigurationValidator:
    ...
    def validate_yaml_syntax(self, file_path: Path) -> Tuple[bool, Optional[Dict[str, Any]]]:
    ...
    def validate_structure(self, config: Dict[str, Any]) -> bool:
        ...
        if 'memory' in config:
            ...
            if 'limits' in mem_config:
                ...
                int_fields = ['default_size_kb', 'max_sections', 'max_items_per_section', 'max_line_length']
