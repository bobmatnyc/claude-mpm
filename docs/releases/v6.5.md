...
- harden MPM against CC 2.1.166 SendMessage authority change: prohibit PM from using SendMessage for scope expansion; add subagent one-turn graceful refusal protocol (#901) (#902)
