...
Claude MPM features a comprehensive suite of specialized coding agents, each optimized for specific programming languages, frameworks, and development paradigms. This catalog provides complete information about available coding agents, their capabilities, and when to use them.
...
|----------|-------------------|
| Microservices | Go Engineer, Rust Engineer, Python Engineer |
| Web Applications | Next.js Engineer, TypeScript Engineer, Ruby Engineer |
| APIs | Python Engineer (FastAPI), PHP Engineer (Laravel), Ruby Engineer (Rails) |
| Performance-Critical | Rust Engineer, Go Engineer |
...
| Pattern | Best Agent |
|---------|------------|
| Service-Oriented | Python Engineer, PHP Engineer |
| DDD/CQRS | PHP Engineer, Go Engineer |
| Clean Architecture | Go Engineer, Rust Engineer, Python Engineer |
| Server Components | Next.js Engineer |
| Concurrency | Go Engineer, Rust Engineer |
...
- **25 comprehensive tests** covering easy/medium/hard scenarios
