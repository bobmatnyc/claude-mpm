...
class CodeTreeBuilder:
    ...
    def build_tree(self, 
                  ...
                  progress_callback: Optional[callable] = None) -> TreeNode:
    ...
    def _build_node(self,
                   ...
                   progress_callback: Optional[callable]) -> Optional[TreeNode]:
    ...
    def compare_trees(self, old_tree: TreeNode, new_tree: TreeNode) -> Dict[str, List[str]]:
