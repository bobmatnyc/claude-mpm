...
class LanguageAnalyzerService:
    ...
    def detect_primary_language(self, file_counts: Optional[Dict[str, int]] = None) -> Optional[str]:
    ...
    def analyze_code_style(self, sample_files: Optional[List[Path]] = None) -> List[str]:
