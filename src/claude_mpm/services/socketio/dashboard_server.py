...
class DashboardServer(SocketIOServiceInterface):
    ...
    def __init__(self, 
        ...
        self.monitor_host = monitor_host or dashboard_config.get("monitor_host", "localhost")
    ...
    def start_sync(self):
        ...
        self.logger.info(f"Connecting to monitor server at {self.monitor_host}:{self.monitor_port}")
    ...
    def _setup_event_relay(self):
        ...
        relay_events = [
            'session_started', 'session_ended', 'claude_status', 'claude_output',
            'agent_delegated', 'todos_updated', 'ticket_created',
            'memory_loaded', 'memory_created', 'memory_updated', 'memory_injected',
            'file_changed', 'git_status_changed', 'project_analyzed',
        ...
        for event_name in relay_events:
            self.monitor_client.add_event_handler(
                event_name, 
                self._create_relay_handler(event_name)
            )
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        dashboard_stats = self.dashboard_server.get_stats() if hasattr(self.dashboard_server, 'get_stats') else {}
        ...
        return {
            **self.stats,
            ...
            "uptime": (
                (datetime.now() - datetime.fromisoformat(self.stats["start_time"])).total_seconds()
    ...
    def session_started(self, session_id: str, launch_method: str, working_dir: str):
        ...
        self.monitor_client.send_to_monitor('session_started', {
    ...
    def claude_status_changed(self, status: str, pid: Optional[int] = None, message: str = ""):
        ...
        self.monitor_client.send_to_monitor('claude_status', {
            "status": status,
            "pid": pid,
            "message": message
        })
    ...
    def claude_output(self, content: str, stream: str = "stdout"):
        ...
        self.monitor_client.send_to_monitor('claude_output', {
            "content": content,
            "stream": stream
        })
    ...
    def agent_delegated(self, agent: str, task: str, status: str = "started"):
        ...
        self.monitor_client.send_to_monitor('agent_delegated', {
            "agent": agent,
            "task": task,
            "status": status
        })
    ...
    def ticket_created(self, ticket_id: str, title: str, priority: str = "medium"):
        ...
        self.monitor_client.send_to_monitor('ticket_created', {
            "ticket_id": ticket_id,
            "title": title,
            "priority": priority
        })
    ...
    def memory_loaded(self, agent_id: str, memory_size: int, sections_count: int):
        ...
        self.monitor_client.send_to_monitor('memory_loaded', {
            "agent_id": agent_id,
    ...
    def memory_created(self, agent_id: str, template_type: str):
        ...
        self.monitor_client.send_to_monitor('memory_created', {
            "agent_id": agent_id,
    ...
    def memory_updated(self, agent_id: str, learning_type: str, content: str, section: str):
        ...
        self.monitor_client.send_to_monitor('memory_updated', {
            "agent_id": agent_id,
    ...
    def memory_injected(self, agent_id: str, context_size: int):
        ...
        self.monitor_client.send_to_monitor('memory_injected', {
            "agent_id": agent_id,
