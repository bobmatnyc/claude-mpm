...
class ServiceContainer:
    ...
    def register(
        ...
        if isinstance(lifetime, bool):
            lifetime = ServiceLifetime.SINGLETON if lifetime else ServiceLifetime.TRANSIENT
    ...
    def _is_valid_implementation(self, service_type: Type, implementation: Type) -> bool:
            ...
            for service_type, descriptor in self._services.items():
                ...
                info[type_name] = {
                    ...
                    "implementation": (
                        ...
                        if descriptor.implementation else None
                    ),
                }
