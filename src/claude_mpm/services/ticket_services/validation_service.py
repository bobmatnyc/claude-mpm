...
class TicketValidationService:
    ...
    VALID_STATUSES = [
        "open", "in_progress", "ready", "tested", "done",
        "waiting", "closed", "blocked", "all"
    ]
    ...
    VALID_WORKFLOW_STATES = [
        "todo", "in_progress", "ready", "tested", "done", "blocked"
    ]
    ...
    def validate_ticket_type(self, ticket_type: str) -> Tuple[bool, Optional[str]]:
        ...
        if ticket_type not in self.VALID_TYPES:
            return False, f"Invalid ticket type: {ticket_type}. Valid types: {', '.join(self.VALID_TYPES)}"
    ...
    def validate_status(self, status: str) -> Tuple[bool, Optional[str]]:
        ...
        if status not in self.VALID_STATUSES:
            return False, f"Invalid status: {status}. Valid statuses: {', '.join(self.VALID_STATUSES)}"
    ...
    def validate_priority(self, priority: str) -> Tuple[bool, Optional[str]]:
        ...
        if priority not in self.VALID_PRIORITIES:
            return False, f"Invalid priority: {priority}. Valid priorities: {', '.join(self.VALID_PRIORITIES)}"
    ...
    def validate_workflow_state(self, state: str) -> Tuple[bool, Optional[str]]:
        ...
        if state not in self.VALID_WORKFLOW_STATES:
            return False, f"Invalid workflow state: {state}. Valid states: {', '.join(self.VALID_WORKFLOW_STATES)}"
    ...
    def validate_create_params(self, params: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
        """
    ...
    def validate_update_params(self, params: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
        """
