...
class IAgentListingService(ABC):
    ...
    @abstractmethod
    def list_deployed_agents(self, verbose: bool = False) -> Tuple[List[AgentInfo], List[str]]:
        """
        ...
        try:
            ...
            for agent_data in agents_data:
                agent = AgentInfo(
                    ...
                    specializations=agent_data.get("specializations") if verbose else None,
    ...
    def compare_versions(self, agent_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                "versions": versions,
                "active_tier": next(
                    (tier for tier, v in versions.items() if v.get("active")),
                    None
                ),
            }
