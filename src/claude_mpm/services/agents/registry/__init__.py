...
from claude_mpm.core.unified_agent_registry import (AgentMetadata, AgentTier,
                                                    AgentType)
...
from .modification_tracker import (AgentModification, AgentModificationTracker,
                                   ModificationHistory, ModificationTier,
                                   ModificationType)
