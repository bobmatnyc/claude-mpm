...
class AgentConfigProvider:
    ...
    def get_agent_specific_config(agent_name: str) -> Dict[str, Any]:
        ...
        return configs.get(agent_name, AgentConfigProvider._get_default_config(agent_name, base_config))
    ...
    @staticmethod
    def _get_default_config(agent_name: str, base_config: Dict[str, Any]) -> Dict[str, Any]:
