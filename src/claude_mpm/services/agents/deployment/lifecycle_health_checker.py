...
class LifecycleHealthChecker:
    ...
    async def perform_health_check(self) -> Dict[str, bool]:
        ...
        try:
            ...
            checks["registry_service"] = self.lifecycle_manager.agent_registry is not None
            checks["tracker_service"] = self.lifecycle_manager.modification_tracker is not None
            checks["persistence_service"] = self.lifecycle_manager.persistence_service is not None
            ...
            checks["agent_records_valid"] = len(self.lifecycle_manager.agent_records) >= 0
            checks["operation_history_valid"] = len(self.lifecycle_manager.operation_history) >= 0
    ...
    async def _test_create_capability(self) -> bool:
        ...
        try:
            ...
            return (self.lifecycle_manager.modification_tracker is not None and 
