...
if TYPE_CHECKING:
    from .agent_lifecycle_manager import AgentLifecycleManager, LifecycleOperationResult, LifecycleOperation
...
class AgentRestoreHandler:
    ...
    async def restore_agent(self, agent_name: str, backup_path: Optional[str] = None) -> 'LifecycleOperationResult':
        ...
        from .agent_lifecycle_manager import LifecycleOperationResult, LifecycleOperation
