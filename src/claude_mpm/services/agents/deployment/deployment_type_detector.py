...
class DeploymentTypeDetector:
        ...
        if templates_dir and templates_dir.exists():
            ...
            try:
                ...
                return ("site-packages/claude_mpm" in templates_str or 
                        ...
                        (paths.agents_dir / "templates").resolve() == templates_dir.resolve())
            except Exception:
                pass
        return False
    
    @staticmethod
    def is_project_specific_deployment(templates_dir: Optional[Path], working_directory: Path) -> bool:
        """
    ...
    def determine_source_tier(templates_dir: Optional[Path]) -> str:
        ...
        if templates_dir:
            ...
            if ".claude-mpm/agents" in templates_str and "/templates" not in templates_str:
                return "PROJECT"
            elif "/.claude-mpm/agents" in templates_str and "/templates" not in templates_str:
                return "USER"
        return "SYSTEM"
