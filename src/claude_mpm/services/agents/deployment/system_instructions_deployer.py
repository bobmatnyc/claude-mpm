    ...
    def deploy_system_instructions(
        ...
        try:
            ...
            banner = (
                ...
                "     Role: merged framework composition (PM_INSTRUCTIONS +"
                " AGENT_DELEGATION + WORKFLOW + MEMORY).\n"
                "     Rebuilt on every startup in dev/filesystem mode.\n"
