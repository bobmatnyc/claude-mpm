...
from claude_mpm.models.agent_definition import AgentDefinition, AgentMetadata, AgentPermissions
...
class AgentDefinitionFactory:
    ...
    def create_agent_definition(self, agent_name: str, agent_content: str, 
