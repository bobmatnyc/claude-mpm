...
from claude_mpm.constants import BANNER_CACHE_NOTICE
...
class InstructionCacheService:
    ...
    def _write_metadata(self, content_hash: str, content_size: int) -> None:
        ...
        Metadata includes:
        - notice: Human-readable "do not edit" banner (keeps the cache file clean)
        ...
        Example metadata:
            {
                "notice": "AUTO-GENERATED by claude-mpm — DO NOT EDIT...",
                "version": "1.0",
                "content_type": "assembled_instruction",
                "content_hash": "abc123...",
