...
class CodeAnalysisRunner:
    ...
    def request_analysis(self, request_id: str, path: str, 
                        languages: Optional[List[str]] = None,
                        max_depth: Optional[int] = None,
        ...
        # Emit queued event
        self._emit_event("code:analysis:queued", {
            "request_id": request_id,
            "path": str(analysis_path),
    ...
    def cancel_current(self):
        ...
        if self.current_process and self.current_process.poll() is None:
            ...
            if self.current_request:
                self._emit_event("code:analysis:cancelled", {
    ...
    def _process_request(self, request: AnalysisRequest):
        ...
        try:
            # Emit start event
            self._emit_event("code:analysis:start", {
            ...
            if self.cancel_event.is_set():
                ...
                self._emit_event("code:analysis:complete", {
                    "request_id": request.request_id,
                    "path": request.path,
                    "stats": {
                ...
                self._emit_error(request.request_id, f"Analysis failed with code {return_code}: {stderr}")
    ...
    def _emit_error(self, request_id: str, message: str):
        ...
        """
        self._emit_event("code:analysis:error", {
            "request_id": request_id,
            "message": message,
