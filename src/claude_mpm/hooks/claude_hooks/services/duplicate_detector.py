...
class DuplicateEventDetector:
    ...
    def __init__(self, max_recent_events: int = 10, duplicate_window_seconds: float = 0.1):
    ...
    def is_duplicate(self, event: dict) -> bool:
        ...
        with self._events_lock:
            ...
            for recent_key, recent_time in self._recent_events:
                if recent_key == event_key and (current_time - recent_time) < self.duplicate_window_seconds:
                    return True
