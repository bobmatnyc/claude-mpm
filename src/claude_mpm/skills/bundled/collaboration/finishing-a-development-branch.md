...
skill_version: 1.0.0
description: Guide completion of development work by verifying tests and presenting structured options for merge, PR, keep, or discard
tags: [git, workflow, pull-requests, merge, worktrees, collaboration]
