...
skill_version: 1.0.0
description: Receive and evaluate code review feedback with technical rigor — verify before implementing, push back when wrong, never perform empty agreement
tags: [code-review, workflow, quality, collaboration, feedback]
...
- Involve a decision-maker if architectural
