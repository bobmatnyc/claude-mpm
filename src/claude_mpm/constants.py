...
# ---------------------------------------------------------------------------
# Auto-generated file banners
#
# These two constants are the single source of truth for the "do not edit"
# notices prepended to auto-generated instruction files.  Import from here
# rather than duplicating the string in each writer.
#
# BANNER_DEPLOYED — written into PM_INSTRUCTIONS_DEPLOYED.md (the merged
