...
def add_analyze_subparser(subparsers):
    ...
    mermaid_group.add_argument(
        "--save-diagrams",
        action="store_true",
        help="Save generated diagrams to files"
    )
    ...
    analysis_group.add_argument(
        "--prompt",
        type=str,
        help="Additional prompt/instructions for the analysis"
    )
    ...
    session_group.add_argument(
        "--session-id",
        type=str,
        help="Use specific session ID for analysis"
    )
    
    session_group.add_argument(
        "--no-session",
        action="store_true",
        help="Run without session management"
    )
