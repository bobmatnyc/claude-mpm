...
class AnalyzeCommand(BaseCommand):
    ...
    def _build_analysis_prompt(self, args) -> str:
        ...
        if args.mermaid:
            types_list = args.mermaid_types if isinstance(args.mermaid_types, list) else [args.mermaid_types]
    ...
    async def _execute_agent_analysis(
        ...
        try:
            ...
            if not deployment_result["success"]:
                self.logger.error(f"Failed to deploy agent {agent}: {deployment_result.get('error')}")
                return None
        ...
        for diagram in diagrams:
            ...
            try:
                with open(filepath, 'w') as f:
                    ...
                    f.write(f"// Generated by Claude MPM Code Analyzer\n")
