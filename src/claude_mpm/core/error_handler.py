...
import traceback
import functools
from typing import Optional, Type, Callable, Any, Dict, List, Union, TypeVar
from contextlib import contextmanager
from enum import Enum

from claude_mpm.core.logging_utils import get_logger
from claude_mpm.core.exceptions import MPMError
from claude_mpm.core.constants import RetryConfig, ErrorMessages
...
class ErrorHandler:
    ...
    def handle(
        ...
        **extra_context
        ...
        elif strategy == ErrorStrategy.RECOVER:
            return self._handle_recovery(error, error_context)
            
        elif strategy == ErrorStrategy.TERMINATE:
    ...
    def _handle_retry(
        ...
        self.logger.warning(
            f"Retry requested for {operation} but not in retry context"
        )
        raise error
