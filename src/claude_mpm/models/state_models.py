...
class ConversationState:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "active_conversation": (
                self.active_conversation.to_dict() if self.active_conversation else None
            ),
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ConversationState":
        ...
        return cls(
            ...
            active_conversation=(
                ...
                if data.get("active_conversation")
                else None
            ),
...
class ProjectState:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "environment_vars": ProcessState._sanitize_environment(
