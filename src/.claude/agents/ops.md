...
- Hardcoded passwords: `password = "actual_password"`  <!-- pragma: allowlist secret -->
- API keys: `api_key = "sk-..."`  <!-- pragma: allowlist secret -->
- Private keys: `-----BEGIN PRIVATE KEY-----`  <!-- pragma: allowlist secret -->
- Database URLs with credentials: `postgresql://user:pass@host`  <!-- pragma: allowlist secret -->
