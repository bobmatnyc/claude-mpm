...
def test_memories_field_extraction():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        success = memory_manager.extract_and_update_memory(test_agent_id, agent_response)
        ...
        success = memory_manager.extract_and_update_memory(test_agent_id, incremental_response)
...
def test_empty_memories_handling():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        test_agent_id = "qa"
        success = memory_manager.extract_and_update_memory(test_agent_id, empty_response)
