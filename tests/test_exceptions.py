    ...
    def test_service_error_with_available_services(self):
        ...
        error = ServiceNotFoundError(
            ...
            context={
                ...
                "available_services": ["Service1", "Service2", "Service3", "Service4", "Service5", "Service6"]
            }
        )
...
class TestErrorSerialization:
    ...
    def test_json_serialization_compatibility(self):
        ...
        errors = [
            ...
            ConnectionError("Connection failed", context={"host": "localhost", "port": 8080})
        ]
    ...
    def test_error_reconstruction_from_dict(self):
        ...
        reconstructed_error = AgentDeploymentError(reconstructed_message, context=reconstructed_context)
