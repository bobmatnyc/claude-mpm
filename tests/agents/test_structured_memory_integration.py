...
def test_memory_change_detection():
    ...
    def check_memory_update_needed(agent_data: dict, memory_content: str, memory_line_count: int) -> bool:
    ...
    assert check_memory_update_needed(agent_data, memory_content, memory_line_count) is True
...
## Other Section"""
    ...
    assert check_memory_update_needed(agent_data_with_memory, memory_content, memory_line_count) is False
    ...
    assert check_memory_update_needed(agent_data_with_memory, memory_content, new_memory_line_count) is True
    ...
    assert check_memory_update_needed(agent_data_with_memory, different_memory, memory_line_count) is True
