...
def test_memory_file_processing():
    ...
    print(
        f"engineer_agent.md -> {extract_agent_name_from_memory_file('engineer_agent.md')}"
    )
...
"""
    ...
    capabilities["memory_size_kb"] = round(
        len(memory_content.encode("utf-8")) / 1024, 2
    )
...
def test_agent_list_with_memory_info():
    ...
    agent_tiers = {"engineer_agent": "project", "qa_agent": "system"}
