...
from claude_mpm.services.agents.deployment.agent_metrics_collector import AgentMetricsCollector
...
class TestAgentMetricsCollector:
    ...
    def test_track_validation_time(self, metrics_collector):
        ...
        validation_times = metrics_collector._deployment_metrics['template_validation_times']
