...
class TestBaseAgentLoading:
    ...
    def test_load_with_cache(self):
        ...
        with patch('claude_mpm.agents.base_agent_loader._get_base_agent_file') as mock_get_file:
            mock_file = MagicMock()
    ...
    def test_force_reload_bypasses_cache(self):
        ...
        with patch('builtins.open', mock_open(read_data='{"narrative_fields": {"instructions": "new content"}}')) as mock_file:
...
"""
            ...
            with patch('claude_mpm.agents.base_agent_loader.load_base_agent_instructions') as mock_load:
...
"""
    ...
    def test_template_override(self):
        ...
        assert len(result) < len(prepend_base_instructions(agent_prompt, complexity_score=90))
...
class TestInstructionPrepending:
    ...
    def test_prepend_when_base_missing(self):
        ...
        with patch('claude_mpm.agents.base_agent_loader.load_base_agent_instructions', return_value=None):
            agent_prompt = "Agent instructions"
            result = prepend_base_instructions(agent_prompt)
    ...
    def test_prepend_test_mode_forces_full_template(self):
        ...
        with patch.dict(os.environ, {'CLAUDE_PM_TEST_MODE': 'true'}):
            ...
            with patch.dict(os.environ, {'CLAUDE_PM_TEST_MODE': 'false'}):
                result_normal = prepend_base_instructions(agent_prompt, complexity_score=10)
...
class TestMemoryOptimization:
    ...
    def test_template_size_reduction(self):
        ...
        minimal = prepend_base_instructions(agent_prompt, template=PromptTemplate.MINIMAL)
        standard = prepend_base_instructions(agent_prompt, template=PromptTemplate.STANDARD)
...
class TestBackwardCompatibility:
    ...
    def test_old_json_format(self):
        ...
        old_format = json.dumps({
            "instructions": "Old format instructions"
        })
    ...
    def test_new_json_format(self):
        ...
        new_format = json.dumps({
            "narrative_fields": {
                "instructions": "New format instructions"
            }
        })
