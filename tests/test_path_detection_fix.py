...
class TestPipxPathDetectionFix(unittest.TestCase):
        ...
        for value in ["0", "false", "False", "no", "No", ""]:
            ...
            with patch("claude_mpm.core.unified_paths.Path") as mock_path:
                ...
                with patch.dict("sys.modules", {"claude_mpm": mock_module}):
                    ...
                    self.assertNotEqual(context, DeploymentContext.DEVELOPMENT,
    ...
    def test_package_root_in_development_mode():
        ...
        # Mock framework root
        with patch.object(pm, "framework_root", new_callable=lambda: MagicMock(return_value=Path("/Users/masa/Projects/claude-mpm"))):
            with patch.object(Path, "exists", return_value=True):
                # Should return src/claude_mpm
                pkg_root = pm.package_root
                self.assertEqual(pkg_root, Path("/Users/masa/Projects/claude-mpm/src/claude_mpm"))
