...
from claude_mpm.services.framework_claude_md_generator import FrameworkClaudeMdGenerator
...
class TestDeploymentManagerConfig:
    ...
    def test_custom_target_filename(self):
        ...
        manager = DeploymentManager(version_manager, validator, target_filename="CLAUDE.md")
    ...
    def test_deploy_uses_configured_filename(self):
        ...
        manager = DeploymentManager(version_manager, validator, target_filename="CUSTOM.md")
    ...
    def test_check_deployment_uses_configured_filename(self):
        ...
        manager = DeploymentManager(version_manager, validator, target_filename="CHECK.md")
    ...
    def test_backup_uses_configured_filename(self):
        ...
        manager = DeploymentManager(version_manager, validator, target_filename="BACKUP.md")
...
class TestFrameworkGeneratorConfig:
    """Test suite for FrameworkClaudeMdGenerator configuration."""
    
    def test_default_configuration(self):
        """Test that generator uses default configuration."""
        generator = FrameworkClaudeMdGenerator()
        assert generator.deployment_manager.target_filename == "INSTRUCTIONS.md"
    
    def test_custom_configuration(self):
        """Test that generator passes custom configuration."""
        generator = FrameworkClaudeMdGenerator(target_filename="CLAUDE.md")
        assert generator.deployment_manager.target_filename == "CLAUDE.md"
    
    def test_backward_compatibility(self):
        """Test that existing code without parameters still works."""
        # This simulates existing code that doesn't pass the new parameter
        generator = FrameworkClaudeMdGenerator()
        
        # Should work without any issues
        assert generator.deployment_manager is not None
        assert generator.deployment_manager.target_filename == "INSTRUCTIONS.md"