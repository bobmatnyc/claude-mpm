...
from claude_mpm.services.agents.deployment.agent_environment_manager import AgentEnvironmentManager
...
class TestAgentEnvironmentManager:
    ...
    def test_set_claude_environment_default_dir(self, env_manager, temp_dir, clean_environment):
    ...
    def test_set_claude_environment_custom_dir(self, env_manager, temp_dir, clean_environment):
    ...
    def test_get_current_environment_with_variables(self, env_manager, clean_environment):
    ...
    def test_validate_environment_missing_config_dir(self, env_manager, temp_dir, clean_environment):
    ...
    def test_validate_environment_existing_config(self, env_manager, temp_dir, clean_environment):
    ...
    def test_validate_environment_warnings(self, env_manager, temp_dir, clean_environment):
        ...
        assert any('Agents directory does not exist' in warning for warning in validation['warnings'])
    
    def test_validate_environment_recommendations(self, env_manager, temp_dir, clean_environment):
    ...
    def test_setup_development_environment(self, env_manager, temp_dir, clean_environment):
    ...
    def test_setup_development_environment_error_handling(self, env_manager, clean_environment):
    ...
    def test_get_environment_info(self, env_manager, clean_environment):
        ...
        assert info['claude_environment_variables']['CLAUDE_CONFIG_DIR'] == '/test/config'
    ...
    def test_environment_variable_precedence(self, env_manager, temp_dir, clean_environment):
