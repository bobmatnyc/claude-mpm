...
class TestClaudeMpmDirectoryLoading:
    ...
    def test_claude_directory_ignored(self, tmp_path):
        ...
        (claude_dir / "INSTRUCTIONS.md").write_text("CLAUDE_DIR_INSTRUCTIONS - SHOULD NOT LOAD")
        ...
        try:
            ...
            assert "CORRECT INSTRUCTIONS" in loader.framework_content.get("custom_instructions", "")
            assert "CORRECT WORKFLOW" in loader.framework_content.get("workflow_instructions", "")
            assert "CORRECT MEMORY" in loader.framework_content.get("memory_instructions", "")
    ...
    def test_precedence_order(self, tmp_path, monkeypatch):
        ...
        try:
            ...
            assert "PROJECT INSTRUCTIONS" in loader.framework_content.get("custom_instructions", "")
            assert "USER INSTRUCTIONS" not in loader.framework_content.get("custom_instructions", "")
            assert loader.framework_content.get("custom_instructions_level") == "project"
            ...
            assert "USER INSTRUCTIONS" in loader.framework_content.get("custom_instructions", "")
    ...
    def test_instructions_in_final_output(self, tmp_path):
        ...
        (claude_mpm_dir / "INSTRUCTIONS.md").write_text("# Custom PM Instructions\nAlways delegate")
        (claude_mpm_dir / "WORKFLOW.md").write_text("# Custom Workflow\nPhase 1: Research")
        (claude_mpm_dir / "MEMORY.md").write_text("# Custom Memory\nRemember everything")
