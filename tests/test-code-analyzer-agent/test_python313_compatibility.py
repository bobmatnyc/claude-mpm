...
def check_python_version():
    ...
    if version_info.major == 3 and version_info.minor >= 13:
        ...
        print(f"⚠️  Running on Python {version_info.major}.{version_info.minor} (test may not be conclusive)")
...
'''
    ...
    try:
        ...
        result = subprocess.run([sys.executable, str(compat_file)], 
                              capture_output=True, text=True, cwd=compat_file.parent)
