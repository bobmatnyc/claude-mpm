...
def test_example():
    ...
    def test_parse_python_dependencies(self, temp_project):
        ...
        assert "pytest" == characteristics.testing_framework
    ...
    def test_analyze_testing_patterns(self, temp_project):
        ...
        assert any("Tests in /tests/ directory" in pattern for pattern in characteristics.test_patterns)
    ...
    def test_get_project_context_summary(self, temp_project):
        ...
        assert any(lang in summary.lower() for lang in ["python", "javascript", "mixed"])
    ...
    def test_error_handling(self, temp_project):
        ...
        with patch.object(analyzer, '_analyze_config_files', side_effect=Exception("Test error")):
            characteristics = analyzer.analyze_project()
