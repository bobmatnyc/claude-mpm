...
from claude_mpm.services.infrastructure.context_preservation import ContextPreservationService
from claude_mpm.storage.state_storage import StateStorage, StateCache
...
class TestStateIntegration:
    ...
    @pytest.mark.asyncio
    async def test_memory_guardian_with_state_manager(self, memory_guardian, monkeypatch):
        ...
        monkeypatch.setattr("claude_mpm.utils.platform_memory.get_process_memory",
    ...
    async def test_complete_restart_scenario(self, temp_dir, monkeypatch):
        ...
        guardian1 = MemoryGuardian(MemoryGuardianConfig(
            enabled=True,
            auto_start=False,
            persist_state=True,
        ...
        guardian2 = MemoryGuardian(MemoryGuardianConfig(
            enabled=True,
            auto_start=False,
            persist_state=True,
            state_file=str(temp_dir / "guardian_state.json")
