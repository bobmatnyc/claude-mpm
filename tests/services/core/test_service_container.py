...
class MultiDependencyService:
    ...
    def __init__(self, test_service: ITestService, dependent_service: IDependentService):
        self.test_service = test_service
    ...
    def get_all_values(self) -> List[str]:
        return [
            ...
            self.dependent_service.process()
        ]
...
class TestServiceContainer:
    ...
    def test_register_factory(self):
        ...
        self.container.register_factory(ITestService, create_service, ServiceLifetime.TRANSIENT)
    ...
    def test_factory_singleton(self):
        ...
        self.container.register_factory(ITestService, create_service, ServiceLifetime.SINGLETON)
    ...
    def test_optional_dependency(self):
        ...
        self.container.register(OptionalDependencyService, OptionalDependencyService, ServiceLifetime.TRANSIENT)
    ...
    def test_get_registration_info(self):
        ...
        self.container.register(ITestService, TestService, ServiceLifetime.SINGLETON)
        self.container.register_instance(IDependentService, DependentService(TestService()))
