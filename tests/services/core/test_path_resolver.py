...
class TestPathResolver:
    ...
    @patch("claude_mpm.services.core.path_resolver.PathResolver._detect_via_unified_paths")
    ...
    @patch("claude_mpm.services.core.path_resolver.PathResolver._check_common_locations")
    @patch("claude_mpm.services.core.path_resolver.PathResolver._detect_development_mode")
    @patch("claude_mpm.services.core.path_resolver.PathResolver._detect_via_package")
    @patch("claude_mpm.services.core.path_resolver.PathResolver._detect_via_unified_paths")
    ...
    def test_get_npm_global_path_success(self, mock_run, resolver):
        ...
        with patch("claude_mpm.services.core.path_resolver.Path.exists") as mock_exists:
            ...
            expected = Path("/usr/local/lib/node_modules/@bobmatnyc/claude-multiagent-pm")
            assert result == expected
    ...
    @patch("claude_mpm.services.core.path_resolver.PathResolver._detect_deployment_context")
    ...
    def test_get_instruction_file_paths_with_framework(self, resolver, tmp_path, monkeypatch):
        """Test getting instruction file paths with framework."""
        # Set up framework directory
        framework_dir = tmp_path / "framework"
        system_instructions = framework_dir / "src" / "claude_mpm" / "agents" / "INSTRUCTIONS.md"
    ...
    def test_detect_deployment_context_pip_install(self, resolver):
        ...
        with patch("claude_mpm.services.core.path_resolver.Path") as MockPath:
            ...
            mock_file.__str__.return_value = "/usr/lib/python3.9/site-packages/claude_mpm/__init__.py"
    ...
    def test_detect_deployment_context_system_package(self, resolver):
        ...
        with patch("claude_mpm.services.core.path_resolver.Path") as MockPath:
            mock_file = MockPath.return_value
            mock_file.__str__.return_value = "/usr/lib/python3.9/dist-packages/claude_mpm/__init__.py"
    ...
    def test_detect_deployment_context_development(self, resolver, tmp_path, monkeypatch):
