...
from claude_mpm.services.cli.memory_crud_service import IMemoryCRUDService, MemoryCRUDService
...
class TestMemoryCRUDService:
    ...
    def test_create_memory_success(self, service, mock_memory_manager):
        ...
        mock_memory_manager.template_generator.generate_template.return_value = "# Test Template"
    ...
    def test_clean_memory_dry_run(self, service, mock_memory_manager):
        ...
        old_file.stat.return_value = MagicMock(
            st_size=1024,
    ...
    def test_clean_memory_specific_agent(self, service, mock_memory_manager):
        ...
        file1.stat.return_value = MagicMock(
            st_size=1024,
            st_mtime=(datetime.now().timestamp() - (35 * 24 * 60 * 60))
        )
...
class TestMemoryCRUDServiceIntegration:
    ...
    def test_lazy_memory_manager_creation(self):
        ...
        with patch('claude_mpm.services.cli.memory_crud_service.AgentMemoryManager') as mock_class, \
