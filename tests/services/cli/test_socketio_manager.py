...
class TestSocketIOManagerStartStop:
    ...
    def test_start_server_success(
        self, mock_pkg_root, mock_scripts_dir, mock_popen, manager
    ):
    ...
    def test_stop_server_force_kill(self, manager):
        ...
        )  # Called twice: after terminate and after kill
        assert 8765 not in manager._server_processes
...
class TestSocketIOManagerPortManagement:
    ...
    def test_wait_for_server_success(
        self, mock_sleep, mock_time, mock_socket_class, manager
    ):
