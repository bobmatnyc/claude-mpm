...
class TestAgentListingService:
    ...
    def test_list_system_agents_error_handling(self, service):
        ...
        service.deployment_service.list_available_agents.side_effect = Exception("Service error")
    ...
    def test_list_deployed_agents_error_handling(self, service):
        ...
        service.deployment_service.verify_deployment.side_effect = Exception("Deployment error")
    ...
    def test_list_agents_by_tier_with_overrides(self, service):
        ...
        service.registry_adapter.registry.list_agents.return_value = {
            "engineer": {"tier": "system", "type": "specialist", "path": "/system/engineer.json"},
        }
        
        tier_info = service.list_agents_by_tier()
        
        # System agent should be marked as active since no override
        system_engineer = next((a for a in tier_info.system if a.name == "engineer"), None)
        if system_engineer:
    ...
    def test_lazy_loading_registry_adapter(self, service):
        ...
        with patch("claude_mpm.services.cli.agent_listing_service.AgentRegistryAdapter") as mock_cls:
