...
class TestAgentOutputFormatter:
    ...
    def test_format_agent_list_text_quiet(self, formatter, sample_agents):
        ...
        result = formatter.format_agent_list(sample_agents, output_format="text", quiet=True)
    ...
    def test_format_agent_list_text_verbose(self, formatter, sample_agents):
        ...
        result = formatter.format_agent_list(sample_agents, output_format="text", verbose=True)
    ...
    def test_format_agent_details_verbose(self, formatter):
        ...
        result = formatter.format_agent_details(agent, output_format="text", verbose=True)
    ...
    def test_format_dependency_report_text(self, formatter, sample_dependencies):
        ...
        result = formatter.format_dependency_report(sample_dependencies, output_format="text")
    ...
    def test_format_dependency_report_with_status(self, formatter):
        ...
        result = formatter.format_dependency_report(deps, output_format="text", show_status=True)
    ...
    def test_format_deployment_result_text(self, formatter, sample_deployment_result):
        ...
        result = formatter.format_deployment_result(sample_deployment_result, output_format="text")
    ...
    def test_format_deployment_result_verbose(self, formatter, sample_deployment_result):
    ...
    def test_format_cleanup_result_no_orphans(self, formatter):
        ...
        result = formatter.format_cleanup_result(result_data, output_format="text", dry_run=True)
    ...
    def test_format_cleanup_result_with_errors(self, formatter):
        ...
        result = formatter.format_cleanup_result(result_data, output_format="text", dry_run=False)
    ...
    def test_format_as_json_compact(self, formatter):
        ...
        assert '{"key": "value", "number": 42}' in result or '{"number": 42, "key": "value"}' in result
    ...
    def test_format_as_table_long_content(self, formatter):
        ...
        rows = [
            ['A', 'This is a very long piece of content that should still be displayed'],
            ['B', 'Short']
        ]
