...
class TestAgentDependencyService:
    ...
    def mock_loader(self):
        ...
        loader = Mock()
        loader.deployed_agents = {"agent1": "/path/to/agent1", "agent2": "/path/to/agent2"}
    ...
    def test_check_dependencies_all_agents(self, mock_loader_class, service, mock_loader):
    ...
    @patch("claude_mpm.services.cli.agent_dependency_service.AgentDependencyLoader")
    def test_check_dependencies_specific_agent(self, mock_loader_class, service, mock_loader):
    ...
    @patch("claude_mpm.services.cli.agent_dependency_service.AgentDependencyLoader")
    def test_check_dependencies_unknown_agent(self, mock_loader_class, service, mock_loader):
    ...
    @patch("claude_mpm.services.cli.agent_dependency_service.AgentDependencyLoader")
    def test_install_dependencies_dry_run(self, mock_loader_class, service, mock_loader):
    ...
    @patch("claude_mpm.services.cli.agent_dependency_service.AgentDependencyLoader")
    def test_install_dependencies_success(self, mock_loader_class, service, mock_loader):
    ...
    @patch("claude_mpm.services.cli.agent_dependency_service.AgentDependencyLoader")
    def test_install_dependencies_failure(self, mock_loader_class, service, mock_loader):
    ...
    @patch("claude_mpm.services.cli.agent_dependency_service.AgentDependencyLoader")
    def test_list_dependencies_text_format(self, mock_loader_class, service, mock_loader):
    ...
    @patch("claude_mpm.services.cli.agent_dependency_service.AgentDependencyLoader")
    def test_list_dependencies_json_format(self, mock_loader_class, service, mock_loader):
    ...
    @patch("claude_mpm.services.cli.agent_dependency_service.AgentDependencyLoader")
    def test_list_dependencies_pip_format(self, mock_loader_class, service, mock_loader):
    ...
    def test_fix_dependencies_with_retry(
        ...
        mock_loader.load_agent_dependencies.return_value = None
        mock_loader.analyze_dependencies.side_effect = [
            {"summary": {"missing_python": ["requests", "numpy"], "missing_system": ["git"]}},
    ...
    def test_fix_dependencies_with_incompatible(
        ...
        mock_loader.load_agent_dependencies.return_value = None
        mock_loader.analyze_dependencies.return_value = {
            "summary": {"missing_python": ["requests", "old-package"], "missing_system": []}
        }
        mock_loader.check_python_compatibility.return_value = (
            ["requests"],  # compatible
