...
class TestVersionService:
    ...
    def test_get_version_with_package_import(self, service):
        ...
        with patch('claude_mpm.__version__', '1.2.3'), \
    ...
    def test_get_version_with_importlib_metadata(self, service):
        ...
        with patch('builtins.__import__', side_effect=lambda name, *args, **kwargs:
                   __import__(name, *args, **kwargs) if name != 'claude_mpm' else (_ for _ in ()).throw(ImportError())), \
    ...
    def test_get_version_with_version_file(self, service):
        ...
        with patch('claude_mpm.__version__', side_effect=ImportError), \
    ...
    def test_error_handling_in_version_detection(self, service):
        ...
        with patch('claude_mpm.__version__', side_effect=Exception("Test error")), \
             patch('importlib.metadata.version', side_effect=Exception("Metadata error")), \
             patch('claude_mpm.config.paths.paths') as mock_paths:
