...
class TestStartupLogging:
    ...
    def test_cleanup_old_startup_logs(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            deleted = cleanup_old_startup_logs(project_root, keep_days=7, keep_min_count=3)
...
"""
    ...
    def test_fix_command_extraction(self):
        ...
        analysis = {
            "errors_found": [
                ("Agent deployment failure", "Check agent configuration in .claude/agents/ and run 'claude-mpm deploy'"),
                ("Missing Python dependency", "Install missing dependencies: pip install claude-mpm[agents]"),
            ],
            "error_count": 2,
            "warning_count": 0,
            "warnings_found": [],
