...
def test_memory_loading():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            print(f"Deployed agents: Engineer, QA")
            print()
            ...
            assert "Test PM memory" in content["actual_memories"], "PM memory content not found"
            ...
            if engineer_loaded:
                assert "Test engineer memory" in agent_memories["Engineer"], "Engineer memory content not found"
            ...
            if qa_loaded:
                assert "Test QA memory" in agent_memories["QA"], "QA memory content not found"
            ...
            all_memory_content = content.get("actual_memories", "") + str(agent_memories)
            ...
            print(f"✓ README.md and NOTES.md NOT loaded")
            ...
            assert total_loaded == expected_count, f"Expected {expected_count} memory sources, got {total_loaded}"
