...
class TestFactorialIterative:
    ...
    def test_boundary_conditions(self):
        ...
        with pytest.raises(ValueError, match="Input too large. Maximum supported value is 170"):
            factorial_iterative(171)
        with pytest.raises(ValueError, match="Input too large. Maximum supported value is 170"):
            factorial_iterative(1000)
    
    def test_large_but_valid_numbers(self):
        """Test factorial of large numbers within limits."""
        # These should succeed without overflow
        result_50 = factorial_iterative(50)
        assert result_50 == 30414093201713378043612608166064768844377641568960512000000000000
...
class TestFactorialWrapper:
    ...
    def test_explicit_iterative(self):
    ...
    def test_invalid_method(self):
        ...
        with pytest.raises(ValueError, match="Invalid method 'invalid'. Choose 'iterative' or 'recursive'."):
            factorial(5, method="invalid")
        with pytest.raises(ValueError, match="Invalid method 'ITERATIVE'. Choose 'iterative' or 'recursive'."):
...
class TestPerformanceAndStress:
    ...
    def test_stress_iterative(self):
    ...
    def test_edge_case_zero_consistency(self):
...
class TestDocstringExamples:
    ...
    def test_iterative_docstring_examples(self):
        """Test examples from factorial_iterative docstring."""
        assert factorial_iterative(5) == 120
        assert factorial_iterative(0) == 1
        assert factorial_iterative(1) == 1
    
    def test_recursive_docstring_examples(self):
        """Test examples from factorial_recursive docstring."""
        assert factorial_recursive(5) == 120
        assert factorial_recursive(0) == 1
        assert factorial_recursive(1) == 1
    
    def test_wrapper_docstring_examples(self):
