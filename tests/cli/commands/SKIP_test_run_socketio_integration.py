...
class TestRunSocketIOIntegration:
    ...
    def test_setup_monitoring_with_socketio_manager(
        self, mock_dashboard, mock_socketio_class, run_command
    ):
        ...
        mock_socketio.start_server.return_value = (
            True,
            ServerInfo(
                port=8765,
                pid=12345,
    ...
    @patch("claude_mpm.cli.commands.run.SocketIOManager")
    def test_setup_monitoring_dependency_failure(
        self, mock_socketio_class, run_command
    ):
    ...
    @patch("claude_mpm.cli.commands.run.SocketIOManager")
    @patch("claude_mpm.cli.commands.run.DashboardLauncher")
    def test_setup_monitoring_server_start_failure(
        self, mock_dashboard, mock_socketio_class, run_command
    ):
    ...
    @patch("claude_mpm.cli.commands.run.SocketIOManager")
    @patch("claude_mpm.cli.commands.run.DashboardLauncher")
    def test_setup_monitoring_browser_not_opened(
        self, mock_dashboard, mock_socketio_class, run_command
    ):
...
class TestLegacySocketIOFunctions:
    ...
    @patch("claude_mpm.cli.commands.run.SocketIOManager")
    @patch("claude_mpm.cli.commands.run.DashboardLauncher")
    def test_launch_socketio_monitor_legacy(
        self, mock_dashboard_class, mock_socketio_class
    ):
