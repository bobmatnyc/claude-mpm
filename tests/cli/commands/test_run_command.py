...
class TestRunCommand:
    ...
    def test_run_with_input_file(mock_exists, mock_config_class, mock_subprocess):
        ...
        with patch('builtins.open', create=True) as mock_open:
            mock_open.return_value.__enter__.return_value.read.return_value = "Test input"
            result = self.command.run(args)
    ...
    def test_run_with_monitor(mock_port_manager, mock_ensure_deps, 
                              mock_webbrowser, mock_config_class, mock_subprocess):
        ...
        mock_port_manager.return_value.get_port.return_value = 8080
    ...
    @patch('claude_mpm.cli.commands.run.subprocess.run')
    @patch('claude_mpm.cli.commands.run.Config')
    def test_run_with_claude_args(mock_config_class, mock_subprocess):
    ...
    @patch('claude_mpm.cli.commands.run.subprocess.run')
    @patch('claude_mpm.cli.commands.run.Config')
    def test_run_with_no_native_agents(mock_config_class, mock_subprocess, mock_list_agents):
