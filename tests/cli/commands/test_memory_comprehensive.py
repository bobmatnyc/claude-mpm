...
class TestMemoryManagementCommand:
    ...
    def test_memory_manager_lazy_loading(self, mock_config_loader, mock_agent_memory_manager):
...
class TestStatusOperations:
    ...
    def test_show_status_json_format(self, memory_command):
        ...
        memory_command.memory_manager.memories_dir.glob.return_value = [mock_file1, mock_file2]
    ...
    def test_show_status_error_handling(self, memory_command):
        ...
        memory_command.memory_manager.memories_dir.exists.side_effect = Exception("Test error")
...
class TestViewOperations:
    ...
    def test_show_memories_single_agent_json(self, memory_command):
        ...
        memory_command.memory_manager.load_agent_memory.return_value = "Test memory content"
...
class TestSearchOperations:
    ...
    def test_cross_reference_text(self, memory_command):
        ...
        with patch("claude_mpm.cli.commands.memory._cross_reference_memory") as mock_cross:
...
class TestRoutingOperations:
    ...
    def test_route_command_text(self, memory_command):
        ...
        with patch("claude_mpm.cli.commands.memory._route_memory_command") as mock_route:
...
class TestErrorHandling:
    ...
    def test_missing_directory_error(self, memory_command):
        ...
        memory_command.memory_manager.memories_dir.exists.side_effect = FileNotFoundError()
    ...
    def test_permission_error(self, memory_command):
        ...
        # Set side_effect on the mocked method
        memory_command.memory_manager.memories_dir.exists.side_effect = PermissionError()
    ...
    def test_invalid_json_format(self, memory_command):
        ...
        memory_command.memory_manager.load_agent_memory.side_effect = Exception("JSON error")
...
class TestManageMemoryFunction:
    ...
    def test_manage_memory_with_json_output(self, mock_config_loader, mock_agent_memory_manager):
...
class TestEdgeCases:
    ...
    def test_unicode_in_memory_content(self, memory_command):
        ...
        memory_command.memory_manager.load_agent_memory.return_value = "Test with émoji 🚀 and unicode"
    ...
    def test_concurrent_access(self, memory_command):
        ...
        memory_command.memory_manager.memories_dir.glob.side_effect = FileNotFoundError()
...
class TestIntegration:
    ...
    def test_command_with_environment_variable(self, mock_config_loader, mock_agent_memory_manager, monkeypatch):
