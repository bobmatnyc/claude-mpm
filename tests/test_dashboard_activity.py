...
def test_activity_tree_content():
    ...
    try:
        response = requests.get("http://localhost:8765/static/dist/components/activity-tree.js", timeout=5)
        if response.status_code != 200:
...
def check_build_files():
    ...
    base_path = Path("/Users/masa/Projects/claude-mpm/src/claude_mpm/dashboard/static/dist")
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print(f"📊 View the test helper: file:///Users/masa/Projects/claude-mpm/test_activity_tab.html")
    else:
