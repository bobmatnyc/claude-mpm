...
"""
    ...
    def test_exec_mode_when_response_logging_disabled(self, mock_popen, mock_execvpe):
        ...
        with patch('claude_mpm.core.claude_runner.ClaudeRunner._create_system_prompt', return_value="test prompt"):
            try:
    ...
    @patch('claude_mpm.core.claude_runner.os.execvpe')
    def test_auto_switch_to_subprocess_when_response_logging_enabled(self, mock_execvpe, mock_subprocess):
        ...
        self.assertTrue(any("Response logging enabled" in str(call) for call in print_calls),
                       "User should be informed about auto-switch to subprocess mode")
        self.assertTrue(any("subprocess mode" in str(call) for call in print_calls),
