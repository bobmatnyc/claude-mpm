...
class TestAgentMemoryManager:
    ...
    def memory_manager(self, temp_project_dir):
        ...
        with patch('claude_mpm.utils.paths.PathResolver.get_project_root', 
    ...
    def test_initialization_creates_directory_structure(self, memory_manager, temp_project_dir):
    ...
    def test_add_learning_respects_item_limits(self, memory_manager):
        ...
        memory_manager.add_learning(
            "qa",
            "mistake",
            "New mistake that should replace oldest"
        )
    ...
    def test_line_length_truncation(self, memory_manager):
        ...
        assert len([line for line in memory.split('\n') 
                   if line.strip().startswith('- A')][0]) <= 122  # "- " prefix
    ...
    def test_validate_and_repair_missing_sections(self, memory_manager):
        ...
        memory_file.write_text("""# Broken Agent Memory
