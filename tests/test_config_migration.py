...
class TestConfigMigratorBasics:
    ...
    def test_init_with_project_root(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert migrator.new_config_path == Path(tmpdir) / ".claude-mpm" / "config.yaml"
...
class TestMigrationProcess:
    ...
    def test_migrate_project_json(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with open(migrator.new_config_path, 'r') as f:
...
class TestBackupAndRestore:
    ...
    def test_restore_from_backup(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert migrator.project_json.exists()
            with open(migrator.project_json, 'r') as f:
...
class TestRollback:
    ...
    def test_rollback_on_error(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Make migration fail
            with patch.object(migrator, '_save_consolidated_config', side_effect=Exception("Save failed")):
                try:
                    migrator.migrate()
...
class TestEdgeCases:
    ...
    def test_very_large_config(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            migrator.config_dir.mkdir(parents=True)
            large_data = {
                'data': ['item' * 100 for _ in range(10000)]  # Large array
            }
            with open(migrator.project_json, 'w') as f:
