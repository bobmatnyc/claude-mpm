...
def connect():
    ...
    todo_event = {
        ...
        "data": {
            "todos": [
                {"content": "Research existing patterns", "activeForm": "Researching patterns", "status": "completed"},
                {"content": "Design new architecture", "activeForm": "Designing architecture", "status": "in_progress"},
                {"content": "Implement solution", "activeForm": "Implementing solution", "status": "in_progress"},
