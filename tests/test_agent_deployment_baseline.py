...
"""
    ...
    def test_set_claude_environment(self, deployment_service, temp_dirs):
        ...
        for key, value in env_vars.items():
            assert key in ['CLAUDE_CONFIG_DIR', 'CLAUDE_MAX_PARALLEL_SUBAGENTS', 'CLAUDE_TIMEOUT']
    ...
    def test_format_version_display(self, deployment_service):
        ...
        version_tuple = (1, 2, 3)
        formatted = deployment_service.version_manager.format_version_display(version_tuple)
