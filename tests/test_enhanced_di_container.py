...
class TestDIContainer:
    ...
    def test_factory_registration(self):
        ...
        container.register_factory(ILogger, create_logger, lifetime=ServiceLifetime.TRANSIENT)
    ...
    def test_named_registrations(self):
        ...
        container.register_singleton(ILogger, instance=secondary_logger, name="secondary")
    ...
    def test_disposal_handler(self):
        ...
        container.register_singleton(ILogger, ConsoleLogger, dispose_handler=dispose_logger)
        container.register_singleton(IDatabase, Database, dispose_handler=dispose_database)
