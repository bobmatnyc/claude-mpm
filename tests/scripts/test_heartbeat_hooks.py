...
class HookEventSimulator:
    ...
    def simulate_user_session(self, session_id: str):
        ...
        self.send_hook_event(
            "subagent_stop",
            {"session_id": session_id, "agent_type": "engineer", "exit_code": 0},
        )
...
class HeartbeatMonitor:
    ...
    def display_heartbeat(self, data):
        ...
        for session in sessions:
            ...
            print(
                f"      {status_icon} {session.get('session_id', '')[:12]}... "
...
def main():
    ...
    try:
        ...
        print("   • Sessions tracked via hooks: 2")
        ...
        if monitor.heartbeats:
            ...
            hook_sessions = [
                s for s in sessions if "hook-session" in s.get("session_id", "")
            ]
