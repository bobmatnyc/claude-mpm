...
def test_memory_system_comprehensive():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        for agent_id in test_agents:
            ...
            assert project_file.exists(), f"{agent_id} memory should be in project directory"
        ...
        test_updates = [
            ...
            ("engineer", "architecture", "Follow SOLID principles in all implementations"),
        ...
        for old_name, agent_id in old_formats:
            ...
            assert new_file.exists(), f"Should migrate to new format"
            assert not old_file.exists(), f"Old file should be deleted after migration"
        ...
        print(f"  ✅ Size limits enforced correctly")
