...
class TestSocketIOServiceSingleton:
    ...
    def test_client_proxy_creation_when_port_in_use(self):
        ...
        with patch("socket.socket") as mock_socket:
            ...
            with patch("claude_mpm.services.socketio_server.SocketIOClientProxy") as mock_proxy:
...
class TestServerLifecycle:
    ...
    def mock_server(self):
        ...
        server.stats = {"events_sent": 0, "events_buffered": 0, "connections_total": 0, "start_time": None}
    ...
    def test_server_start_sync(self, mock_server):
        ...
        with patch.object(server.core, 'start_sync') as mock_core_start:
            with patch('claude_mpm.services.socketio.server.main.ConnectionManager') as mock_conn_mgr:
                with patch('claude_mpm.services.socketio.server.main.SocketIOEventBroadcaster') as mock_broadcaster:
                    with patch('claude_mpm.services.socketio.server.main.EventBusIntegration') as mock_eventbus:
                        # Setup mocks
...
class TestEventBroadcasting:
    ...
    def server_with_broadcaster(self):
        ...
        from claude_mpm.services.socketio.server.broadcaster import SocketIOEventBroadcaster
    ...
    def test_broadcast_with_namespace_isolation(self, server_with_broadcaster):
        ...
        with patch.object(server.core.sio, 'emit') as mock_emit:
            ...
            asyncio.run(server.core.sio.emit(
                "namespace_event", 
                {"data": "test"}, 
                namespace=namespace
            ))
...
class TestConnectionPooling:
    ...
    def test_connection_manager_initialization(self):
        ...
        """
        from claude_mpm.services.socketio.server.connection_manager import ConnectionManager
    ...
    async def test_connection_health_monitoring(self):
        ...
        manager.add_connection("client2", {"connected_at": time.time() - 120})  # Old connection
    ...
    def test_connection_pool_limits(self):
        ...
        result = manager.add_connection("client_overflow", {})
