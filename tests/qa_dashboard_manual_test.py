...
class ManualDashboardTester:
    ...
    def open_dashboard_in_browser(self):
        ...
        dashboard_url = f"{self.server_url}/dashboard?autoconnect=true&port=8765"
        ...
        events = [
            ...
            # File operations
            {
                ...
                "data": {
                    ...
                    "agent_type": "engineer",
                    "arguments": {
                        "file_path": "/Users/masa/Projects/claude-mpm/src/claude_mpm/dashboard/templates/index.html"
                    }
                }
            },
            {
