...
from claude_mpm.services.agents.deployment.agent_format_converter import AgentFormatConverter
...
"""
    ...
    def test_convert_yaml_to_md_skip_newer_md(self, format_converter, temp_dir_with_yaml):
...
instructions: |
  ...
  It performs testing tasks."""
        ...
        md_content = format_converter.convert_yaml_content_to_md(yaml_content, "test-agent")
...
instructions: |
  ...
  It has multiple lines."""
        ...
        instructions = format_converter._extract_instructions_from_yaml(yaml_content, 'test-agent')
        
        assert 'This is the instruction text.' in instructions
        assert 'It has multiple lines.' in instructions
    
    def test_extract_instructions_from_yaml_with_long_description(self, format_converter):
