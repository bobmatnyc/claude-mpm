...
''')
    ...
    def test_analysis_runner_initialization(self, analysis_runner):
        ...
        assert analysis_runner.running == False
        ...
        assert analysis_runner.running == True
    ...
    def test_event_handler_initialization(self, event_handler):
        ...
        assert event_handler.analysis_runner.running == True
    ...
    def test_analysis_runner_event_emission(self, analysis_runner, mock_server, temp_project_dir):
    ...
    def test_analysis_cancellation(self, analysis_runner, mock_server, temp_project_dir):
        ...
        analysis_runner.request_analysis(
            request_id=request_id,
            path=temp_project_dir
        )
    ...
    @pytest.mark.asyncio
    async def test_event_handler_request_processing(self, event_handler, temp_project_dir):
