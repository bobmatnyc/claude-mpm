...
def test_agent_capabilities_discovery():
    ...
    preview = capabilities_section[:1500] if len(capabilities_section) > 1500 else capabilities_section
    print(preview)
    ...
    has_usage_note = "IMPORTANT" in capabilities_section and "exact agent ID" in capabilities_section
    if has_usage_note:
