...
def test_path_resolution():
    ...
    # Test 1: Test utils/paths.py get_path_manager()
    print("\n1. Testing get_path_manager() (utils/paths.py):")
    print("-" * 40)
    ...
    try:
        ...
        agents_dir = get_path_manager().get_agents_dir()
        ...
        resource_path = get_path_manager().get_package_resource_path('agents/templates')
        print(f"    agents/templates: {resource_path}")
        print(f"    Exists: {resource_path.exists()}")
        
        # Test with a specific file
        try:
            template_file = get_path_manager().get_package_resource_path('agents/templates/engineer.json')
