...
async def test_hello_world_tool(verbose: bool = False):
    ...
    test_cases = [
        ...
        },
        {
            ...
            "params": {"mode": "time_based"}
        },
        {
            "name": "Multi-language (Spanish)",
            "params": {"mode": "multi_language", "language": "spanish", "name": "Usuario"}
        },
        {
        ...
        {
            "name": "System Info Greeting",
            "params": {"mode": "system_info"}
        },
        {
        ...
        },
        {
            ...
            "params": {"mode": "simple", "uppercase": True}
        },
        {
            "name": "Repeated Greeting",
            "params": {"mode": "simple", "repeat": 3}
        },
        {
            "name": "Full Metadata",
            "params": {"mode": "personalized", "name": "Developer", "include_metadata": True}
        }
    ]
    ...
    for test_case in test_cases:
        ...
        try:
            ...
            if result.success:
                successful_tests += 1
                if verbose:
                    print(f"      Parameters: {json.dumps(test_case['params'], indent=8)}")
                    print(f"      Response: {json.dumps(result.data, indent=8, ensure_ascii=False)}")
    ...
    error_cases = [
        ...
        {
            "name": "Personalized without name",
    ...
    print("Test Summary")
    print("=" * 60)
    print(f"Greeting modes tested: {successful_tests}/{successful_tests + failed_tests}")
