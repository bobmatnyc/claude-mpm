...
from claude_mpm.utils.environment_context import EnvironmentContext, should_prompt_for_dependencies
...
def test_agent_change_detection():
...
def test_smart_dependency_checker():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            if results['summary']['satisfied_python']:
                print(f"   Satisfied Python deps: {results['summary']['satisfied_python'][:3]}")
