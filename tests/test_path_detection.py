...
def test_path_detection():
    ...
    try:
        from claude_mpm.core.unified_paths import get_path_manager, PathContext, DeploymentContext
        ...
        if not is_dev_paths and context != DeploymentContext.PIPX_INSTALL:
            print("⚠️  WARNING: Not using development paths but not in pipx install mode!")
