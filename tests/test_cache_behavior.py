...
def test_cache_ttl_expiration():
    ...
    try:
        ...
        print(f"3. Waiting {loader.CAPABILITIES_CACHE_TTL + 1} seconds for TTL expiration...")
        ...
        if third_time > second_time * 2:
            print("   ✓ TTL expiration confirmed - third call took longer than cached call")
        else:
...
def test_manual_cache_clearing():
    ...
    assert loader._deployed_agents_cache is not None, "Deployed agents cache should be populated"
    assert loader._agent_capabilities_cache is not None, "Capabilities cache should be populated"
    ...
    assert loader._deployed_agents_cache is None, "Deployed agents cache should be cleared"
    assert loader._agent_capabilities_cache is None, "Capabilities cache should be cleared"
