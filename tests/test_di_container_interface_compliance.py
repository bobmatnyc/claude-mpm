...
class TestDIContainerInterfaceCompliance:
    ...
    def test_di_container_implements_interface(self):
        ...
        assert isinstance(container, IServiceContainer), "DIContainer must inherit from IServiceContainer"
    ...
    def test_register_instance_method_exists(self):
        ...
        # Method should exist
        assert hasattr(container, 'register_instance'), "DIContainer must have register_instance method"
    ...
    def test_resolve_all_method_exists(self):
        ...
        # Method should exist
        assert hasattr(container, 'resolve_all'), "DIContainer must have resolve_all method"
    ...
    def test_is_registered_method_exists(self):
        ...
        # Method should exist
        assert hasattr(container, 'is_registered'), "DIContainer must have is_registered method"
    ...
    def test_interface_method_signatures_match(self):
        ...
        for method_name in interface_methods:
            assert hasattr(container, method_name), f"DIContainer must have {method_name} method"
