...
class TestAgentDeployment:
    ...
    def test_agent_count_exactly_ten(self, deployment_service, tmp_path):
        ...
        agent_names = [
            "engineer", "qa", "documentation", "research", "security",
            "ops", "data_engineer", "version_control", "test_integration", "pm"
        ]
...
"""
    ...
    def test_error_handling_invalid_template(self, deployment_service, tmp_path):
        ...
        assert {r['name'] for r in results['deployed']} == {'minimal_agent', 'valid_agent'}
