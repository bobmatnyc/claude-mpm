...
class TestHookInstaller(unittest.TestCase):
    ...
    def test_get_hook_script_path_development(self):
        ...
        with patch('src.claude_mpm.hooks.claude_hooks.installer.claude_mpm') as mock_module:
    ...
    def test_install_hooks_success(self, mock_get_script, mock_version_check):
        ...
        with patch.object(self.installer, '_install_commands'), \
    ...
    def test_verify_hooks_valid(self, mock_get_script):
        ...
        # Mock version check
        with patch.object(self.installer, 'is_version_compatible', return_value=(True, "Compatible")), \
    ...
    def test_verify_hooks_missing_settings(self):
        ...
        with patch.object(self.installer, 'is_version_compatible', return_value=(True, "Compatible")), \
             patch.object(self.installer, 'get_hook_script_path', return_value=Path("/hook.sh")):
    ...
    def test_verify_hooks_incompatible_version(self):
        ...
        with patch.object(self.installer, 'is_version_compatible', 
    ...
    def test_verify_hooks_missing_events(self, mock_get_script):
        ...
        with patch.object(self.installer, 'is_version_compatible', return_value=(True, "Compatible")), \
            ...
            missing_events = ["SubagentStop", "SubagentStart", "PreToolUse", "PostToolUse"]
        ...
        with patch.object(Path, '__new__') as mock_path:
            def path_new(cls, *args, **kwargs):
                if args and "installer.py" in str(args[0]):
                    ...
                    return package_root / "src" / "claude_mpm" / "hooks" / "claude_hooks" / "installer.py"
    ...
    def test_settings_backup_and_restore(self):
        ...
        initial_content = self.installer.settings_file.read_text()
