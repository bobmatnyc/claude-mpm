...
def test_memory_system():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        duplicate_learning = ["API rate limit is 100/min (undocumented)"]  # Same as before
        ...
        if success:
            ...
            if "New memory item 1" in final_memory and "Database connection pool" not in final_memory:
