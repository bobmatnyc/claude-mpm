...
class TestResponseLoggingComprehensive(unittest.TestCase):
    ...
    def test_hook_handler_initialization_disabled(self):
        ...
        try:
            ...
            self.assertFalse(handler.response_tracking_enabled, 
    ...
    def test_hook_handler_initialization_enabled(self):
        ...
        try:
            ...
            self.assertTrue(handler.response_tracking_enabled, 
                          "Response tracking should be enabled via config file")
            self.assertIsNotNone(handler.response_tracker, 
                               "Response tracker should be initialized")
    ...
    def test_basic_response_storage(self):
        ...
        self.assertEqual(response_data['request'], 'Test prompt for basic functionality')
    ...
    def test_large_response_handling(self):
        ...
        print(f"   Response file size: {response_path.stat().st_size / 1024 / 1024:.2f} MB")
    ...
    def test_concurrent_access(self):
        ...
        total_responses = sum(len(tracker.get_session_responses(s)) for s in all_sessions)
    ...
    def test_error_handling_invalid_json(self):
        ...
        self.assertTrue(len(response_files) > 0, "Should have at least one response file")
    ...
    def test_cleanup_functionality(self):
        ...
        old_file = old_session_dir / f"old_agent-{old_timestamp.strftime('%Y%m%d_%H%M%S_000')}.json"
...
def main():
    ...
    # Run unit tests
    test_suite = unittest.TestLoader().loadTestsFromTestCase(TestResponseLoggingComprehensive)
