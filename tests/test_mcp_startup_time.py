...
from claude_mpm.services.mcp_gateway.core.process_pool import get_process_pool, pre_warm_mcp_servers
...
def measure_cold_start():
    ...
    subprocess.run([sys.executable, "scripts/cleanup_mcp_processes.py"], 
...
def check_memory_usage():
    ...
    for line in result.stdout.splitlines():
        if any(keyword in line.lower() for keyword in ["mcp", "vector_search"]) and "grep" not in line:
