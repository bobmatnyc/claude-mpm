...
class TestAgentTemplateBuilder:
    ...
    def test_build_agent_markdown_basic(self, template_builder, sample_template_file, base_agent_data):
    ...
    def test_build_agent_markdown_invalid_name(self, template_builder, sample_template_file, base_agent_data):
    ...
    def test_build_agent_markdown_tools_with_spaces(self, template_builder, temp_dir, base_agent_data):
        ...
        with pytest.raises(ValueError, match="Tools must be comma-separated WITHOUT spaces"):
            template_builder.build_agent_markdown(
                agent_name="test_agent",
    ...
    def test_build_agent_markdown_missing_file(self, template_builder, temp_dir, base_agent_data):
    ...
    def test_build_agent_markdown_invalid_json(self, template_builder, temp_dir, base_agent_data):
    ...
    def test_build_agent_yaml_basic(self, template_builder, sample_template_file, base_agent_data):
    ...
    def test_merge_narrative_fields(self, template_builder):
        ...
        template_data = {
            "when_to_use": ["Testing", "General tasks"],  # Overlap should be deduplicated
            "specialized_knowledge": ["Test frameworks"],
            "unique_capabilities": ["Test execution"]
        }
        ...
        # Check deduplication
        assert len(result["when_to_use"]) == 2  # "General tasks" should appear only once
