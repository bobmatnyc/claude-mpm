...
from claude_mpm.utils.subprocess_utils import cleanup_orphaned_processes, get_process_info
import psutil
...
def main():
    ...
    for proc in hook_processes:
        status = "🟢 Recent" if proc['age_minutes'] < 5 else "🟡 Old" if proc['age_minutes'] < 60 else "🔴 Orphaned"
