...
def test_ticketing_instructions():
    ...
    checks = [
        ...
        ("Epic keyword triggers listed",
         '"epic", "epics"' in content),
        ("Issue keyword triggers listed",
         '"issue", "issues"' in content),
        ("Task tracking mentioned",
         '"task tracking", "task management"' in content),
