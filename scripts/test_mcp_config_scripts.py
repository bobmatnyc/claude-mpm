...
def test_registration_script():
    ...
    try:
        ...
        result = subprocess.run(
            [sys.executable, "scripts/register_mcp_gateway.py", "--dry-run", "--config-path", str(tmp_path)],
            capture_output=True,
            text=True
        )
        ...
        result = subprocess.run(
            [sys.executable, "scripts/register_mcp_gateway.py", "--config-path", str(tmp_path)],
            capture_output=True,
            text=True
        )
