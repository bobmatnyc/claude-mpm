...
from claude_mpm.services.agents.registry.deployed_agent_discovery import DeployedAgentDiscovery
from claude_mpm.services.agents.management.agent_capabilities_generator import AgentCapabilitiesGenerator
...
def test_capabilities_generation():
    ...
    checks = [
        ...
        ("Engineering Agents section", "### Engineering Agents" in capabilities_content or "engineer" in capabilities_content),
        ("Research Agents section", "### Research Agents" in capabilities_content or "research" in capabilities_content),
    ...
    framework_checks = [
        ...
        ("Usage instructions", "Task tool" in framework_capabilities or "delegating tasks" in framework_capabilities)
    ]
    ...
    print("\n" + "=" * 60)
    print("Test Summary:")
    all_passed = all(check[1] for check in checks) and all(check[1] for check in framework_checks)
    if all_passed:
