...
class HUDTestSuite:
    ...
    def test_file_structure(self):
        ...
        required_files = [
            "src/claude_mpm/web/static/js/components/hud-visualizer.js",
            "src/claude_mpm/web/templates/index.html",
            "src/claude_mpm/web/static/css/dashboard.css",
            "src/claude_mpm/web/static/js/dashboard.js"
        ]
    ...
    def test_html_structure(self):
        ...
        html_file = project_root / "src/claude_mpm/web/templates/index.html"
    ...
    def test_css_structure(self):
        ...
        css_file = project_root / "src/claude_mpm/web/static/css/dashboard.css"
