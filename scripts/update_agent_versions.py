...
def generate_summary(json_updates: List[Tuple[str, str, str]], 
                     md_updates: List[Tuple[str, str, str]]) -> str:
    ...
    md_versions = {name.replace('-', '_').replace('_agent', ''): new 
                   for name, _, new in md_updates}
