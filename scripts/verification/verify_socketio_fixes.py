...
def check_server_config():
    ...
    try:
        ...
        core_file = Path(__file__).parent.parent / "src/claude_mpm/services/socketio/server/core.py"
...
def check_handler_config():
    ...
    try:
        from src.claude_mpm.services.socketio.handlers.connection import ConnectionEventHandler
        
        # Read the source to verify actual values
        handler_file = Path(__file__).parent.parent / "src/claude_mpm/services/socketio/handlers/connection.py"
...
def check_client_config():
    ...
    try:
        ...
        client_file = Path(__file__).parent.parent / "src/claude_mpm/dashboard/static/js/socket-client.js"
...
def check_relay_config():
    ...
    try:
        from src.claude_mpm.services.event_bus.relay import SocketIORelay
        
        # Read the source to verify actual values
        relay_file = Path(__file__).parent.parent / "src/claude_mpm/services/event_bus/relay.py"
