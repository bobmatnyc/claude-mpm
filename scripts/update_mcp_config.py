...
def update_mcp_config():
    ...
    config["mcpServers"]["claude-mpm-gateway"] = {"command": "claude-mpm-mcp"}
    ...
    print(
        "   - 5 basic tools (echo, calculator, system_info, run_command, summarize_document)"
    )
    print(
        "   - 5 ticket tools (ticket_create, ticket_list, ticket_update, ticket_view, ticket_search)"
    )
