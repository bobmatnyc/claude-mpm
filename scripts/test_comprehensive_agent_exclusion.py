...
def create_test_config(config_path: Path, excluded_agents: List[str], case_sensitive: bool = False):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            if exclusion_count == expected_count:
                ...
                results["errors"].append(f"Expected {expected_count}, got {exclusion_count}")
...
def test_case_sensitivity() -> Dict[str, any]:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            create_test_config(config_dir / "configuration.yaml", excluded, case_sensitive=False)
            ...
            create_test_config(config_dir / "configuration.yaml", excluded, case_sensitive=True)
...
"""
        ...
        if "Including all agents" in stdout or "exclusion configuration overridden" in stdout:
