...
async def capture_dashboard_state(browser_context):
    ...
    try:
        ...
        try:
            ...
            event_items = await page.query_selector_all('div[class*="event"], li[class*="event"], .event-item, [data-testid*="event"]')
            ...
            for event in events_text:
                if any(keyword in event.lower() for keyword in ['hook', 'pre_tool', 'post_tool', 'subagent']):
        ...
        try:
            ...
            if events_tab:
                ...
                events_section = await page.query_selector('[data-testid*="events"], div:has-text("Events")')
                if events_section:
        ...
        try:
            ...
            if not has_hooks:
                ...
                try:
                    ...
                    has_hooks_after, screenshot_after = await capture_dashboard_state(context)
