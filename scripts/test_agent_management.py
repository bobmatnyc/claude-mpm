        ...
        if available_agents:
            ...
            try:
                ...
                if agents_dir.exists():
                    agent_files = list(agents_dir.glob('*.json')) + list(agents_dir.glob('*.yaml')) + list(agents_dir.glob('*.yml'))
...
def test_agent_import_functionality():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert imported_agent['name'] == 'test-agent', "Agent content should be preserved"
