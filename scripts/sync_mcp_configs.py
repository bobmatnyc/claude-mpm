...
def main():
    ...
    parser.add_argument(
        "--to-code", action="store_true", help="Copy Desktop servers to Code"
    )
    parser.add_argument(
        "--to-desktop", action="store_true", help="Copy Code servers to Desktop"
    )
    parser.add_argument(
        "--merge", action="store_true", help="Merge servers from both configurations"
    )
    parser.add_argument(
        "--status", action="store_true", help="Show current configuration differences"
    )
    parser.add_argument(
