...
def test_deployment_with_user_directory():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print(f"✓ AgentDeploymentService correctly using user directory: {deployment_service.working_directory}")
...
def test_deployment_without_env_var():
    ...
    print(f"✓ Without env var, correctly falls back to current directory: {deployment_service.working_directory}")


def test_deployment_with_explicit_working_dir():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print(f"✓ Explicit directory parameter takes precedence: {deployment_service.working_directory}")
