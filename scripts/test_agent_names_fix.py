...
def test_documentation_generator():
    ...
    from claude_mpm.services.framework_claude_md_generator.section_generators.todo_task_tools import TodoTaskToolsGenerator
                ...
                if content.startswith('---'):
                    ...
                    if end_marker > 0:
                        ...
                        if metadata and 'name' in metadata:
                            print(f"  ✅ {agent_file.name}: YAML name = '{metadata['name']}'")
    else:
