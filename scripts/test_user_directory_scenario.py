...
def test_user_directory_scenario():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        print(f"✓ ClaudeRunner deployment service using user directory: {runner.deployment_service.working_directory}")
        ...
        assert user_claude_agents.exists(), f"Agents should be deployed to {user_claude_agents}"
