...
def test_config_singleton():
    ...
    if (service1.config.get("test_key") == "test_value" and
        service2.config.get("test_key") == "test_value"):
...
def check_log_messages():
    ...
    created_count = sum(1 for line in lines if "Creating new Config singleton instance" in line)
    reused_count = sum(1 for line in lines if "Reusing existing Config singleton instance" in line)
    loaded_count = sum(1 for line in lines if "Successfully loaded configuration" in line)
