...
def deploy_project_agents():
    ...
    print(f"🚀 Deploying {len(json_files)} project agents from {source_dir} to {target_dir}")
    ...
    for json_file in json_files:
        try:
            ...
            if agent_id.lower() in EXCLUDED_AGENTS:
                ...
                print(f"  ⚠️  Skipping {agent_id} (PM is the main Claude instance, not a subagent)")
                continue
