    ...
    async def setup(self):
        ...
        config = MemoryGuardianConfig(
            ...
            thresholds=MemoryThresholds(
                warning=100,    # Low thresholds for testing
                critical=200,
                emergency=300
            ),
...
"""
    ...
    async def test_automatic_restart(self):
        ...
        try:
            ...
            with mock.patch.object(self.guardian, 'restart_process', side_effect=mock_restart):
                with mock.patch.object(self.guardian, 'get_memory_usage', return_value=350.0):
            ...
            if protection:
                ...
                for i in range(5):
                    ...
                    if i < 3:
                        ...
                        print(f"  → Restart {i+1}: {'Allowed' if allowed else f'Blocked ({reason})'}")
                    else:
                        allowed, reason = protection.should_allow_restart()
                        assert not allowed
